...
public interface BlogUserMapper extends BaseMapper<BlogUser> {
	 ...
	 * 根据用户名查询密码
	 */
	Map<String,Object> selectPwdByUsername(@Param("loginName") String loginName);
	/**
	 * 根据用户名查询密码
	 */
	Map<String,Object> selectPwdByEmail(@Param("loginName") String loginName);
	/**
	 * 根据用户名查询密码
	 */
	Map<String,Object> selectPwdByPhoneNumber(@Param("loginName") String loginName);
}
