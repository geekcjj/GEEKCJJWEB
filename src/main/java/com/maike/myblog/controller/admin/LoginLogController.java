package com.maike.myblog.controller.admin;
...
public class LoginLogController extends BaseController {
	@RequestMapping(value = "/loginlog/insertUserLoginLog", method = { RequestMethod.POST, RequestMethod.GET })
	...
	@RequestMapping(value = "/loginlog/listUserLoginLog", method = { RequestMethod.POST, RequestMethod.GET })
	...
	@RequestMapping(value = "/loginlog/deleteUserLoginLog", method = { RequestMethod.POST, RequestMethod.GET })
